...
%   Inciso 1  
%   Asignar valores a R=4,7Kohm, L=10uHy, y C=100nF. Obtener simulaciones que permitan 
...
[num,den]=ss2tf(A,B,C,D); %obtengo la FT a partir del 
                          %espacio de estados dado y luego los polos
