...
%   Inciso2
% Incorporar un observador para el caso en que sólo puedan medirse el desplazamiento y el ángulo, 
...
% alfa(1)=.4; color='b';
% alfa(1)=.8; color='m';
% alfa(1)=1.2; color='k'; %Angulo inicial máximo para LQR sin obs
...
subplot(3,2,3); plot(t,p,color,'LineWidth',1.5);grid on;title('Posición carro');hold on;
