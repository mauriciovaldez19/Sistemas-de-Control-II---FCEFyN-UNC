...
tR=log(0.95)/polos(1); %intervalo de integracion -> dinámica mas rápida, tomo 1e-10 por cuestiones de simplicidad

tL=log(0.05)/polos(2); %tiempo de simulacion para entrada invariable -> dinámica mas lenta, tomo 4-e3
